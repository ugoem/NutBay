...
<!-- Start of Header -->
	...
	<?php include'app/views/layouts/messages.inc.html.php'; ?>
				...
				<div class="map-wrap" style="width:500px; height: 600px;" >
					<div class="register-box  d-flex flex-column" >
					  <!-- /logo -->
						...
						<form method="post" name="signup" action="?<?php echo $action . '&email='. $email; ?>"  onSubmit = "return checkpass();" >
								...
								<div class="input-group mb-3">
								  <input name = "phone" value = "<?php  echo $contno; ?>" type="text" class="form-control" placeholder="Phone Number" required>
								  <div class="input-group-append">
									<div class="input-group-text">
								...
								<button type="submit" class="btn btn-success btn-block"><?php echo $button; ?></button> 
								  </div>
								  <!-- /.col -->
								</div>
							  </form>
							  ...
							  <div class="social-auth-links text-center">
								...
								<a href="#" class="btn btn-block btn-danger">
								 ...
								 Already  a member?    
							  <a href="app/" class="text-center"> Login</a> 
							</div>
							<!-- /.form-box -->
						  </div><!-- /.card -->
