<?php 
	...
	if (isset($_GET['submitcontactform']))
	{
		function sanitize($data)
		{
			...
			{
				$to = "info@didoversol.ng," .$cemail;      //Receipient email
				//$to2 = $cemail;
				$headers = 'MIME-Version: 1.0' .'\r\n';
				$headers .= 'Content-Type: text/html; charset=utf-8' .'\r\n';
				$headers .= 'From: ' . $cemail .'\r\n';
				...
				$htmlcontent = 'Sender: <b>'. $cname .'</b> <br>' ;
			
				$htmlcontent .= $message .'<br>';
				$htmlcontent .= $ipDetails .'<br>';
				$htmlcontent .=  '<p><b>This email was sent from</b>' . $_SERVER['HTTP_REFERER'] . '</p> <br>';
